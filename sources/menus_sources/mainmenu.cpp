...
void MainMenu::makeMainMenu(MainWindow* mainWindow)
{
    ...
    QRect rect((int)MainMenuProps::verLayoutX, (int)MainMenuProps::verLayoutY,
              (int)MainMenuProps::verLayoutW, (int)MainMenuProps::verLayoutH);
    _widgetForVerLayout->setGeometry(rect);
    rect.setRect((int)MainMenuProps::horLayoutX, (int)MainMenuProps::horLayoutY,
                (int)MainMenuProps::horLayoutW, (int)MainMenuProps::horLayoutH);
    _widgetForHorLayout->setGeometry(rect);

    /* Version text label */
    _versionTextLabel->setGeometry((int)MainMenuProps::VersionTextLabelX, (int)MainMenuProps::VersionTextLabelY,
                                  (int)MainMenuProps::VersionTextLabelW, (int)MainMenuProps::VersionTextLabelH);
